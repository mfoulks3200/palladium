...
All contributors must read and follow `STANDARDS.md` before making changes. It covers the branch workflow, merge requirements, commit message conventions, and code quality expectations.
